...
export class NetworkLogViewColumns {
  ...
  _createWaterfallHeader() {
    ...
    this._waterfallHeaderElement.addEventListener('contextmenu', event =>
      this._innerHeaderContextMenu(new UI.ContextMenu.ContextMenu(event))
    );
  ...
  _innerHeaderContextMenu(contextMenu) {
    ...
    responseSubMenu
      .footerSection()
      .appendItem(Common.UIString.UIString('Manage Header Columns…'), this._manageCustomHeaderDialog.bind(this));
    ...
    waterfallSubMenu
      .defaultSection()
      .appendCheckboxItem(
        Common.UIString.UIString('Start Time'),
    ...
    waterfallSubMenu
      .defaultSection()
      .appendCheckboxItem(
        Common.UIString.UIString('Response Time'),
    ...
    waterfallSubMenu
      .defaultSection()
      .appendCheckboxItem(
        Common.UIString.UIString('End Time'),
    ...
    waterfallSubMenu
      .defaultSection()
      .appendCheckboxItem(
        Common.UIString.UIString('Total Duration'),
    ...
    waterfallSubMenu
      .defaultSection()
      .appendCheckboxItem(
        Common.UIString.UIString('Latency'),
...
export const _defaultColumns = [
  ...
  {
    id: 'priority',
    title: Common.UIString.UIString('Priority'),

...
import * as Network from '../chii_network/chii_network.js';
...
export class ServiceWorkerCacheView extends UI.View.SimpleView {
  ...
  constructor(model, cache) {
    ...
    this.registerRequiredCSS('chii_resources/serviceWorkerCacheViews.css');
  ...
  wasShown() {
    this._model.addEventListener(
      SDK.ServiceWorkerCacheModel.Events.CacheStorageContentUpdated,
      this._cacheContentUpdated,
      this
    );
...
export class RequestView extends UI.Widget.VBox {
  ...
  constructor(request) {
    ...
    this._tabbedPane.appendTab(
      'headers',
      Common.UIString.UIString('Headers'),
      new Network.RequestHeadersView.RequestHeadersView(request)
    );
    this._tabbedPane.appendTab(
      'preview',
      Common.UIString.UIString('Preview'),

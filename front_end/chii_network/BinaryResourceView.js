...
export class BinaryResourceView extends UI.Widget.VBox {
  ...
  constructor(base64content, contentUrl, resourceType) {
    super();
    this.registerRequiredCSS('chii_network/binaryResourceView.css');
    ...
    this._binaryResourceViewFactory = new SourceFrame.BinaryResourceViewFactory.BinaryResourceViewFactory(
      base64content,
      contentUrl,
      resourceType
    );
    ...
    this._binaryViewTypeCombobox = new UI.Toolbar.ToolbarComboBox(

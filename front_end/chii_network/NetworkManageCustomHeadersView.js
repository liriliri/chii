...
export class NetworkManageCustomHeadersView extends UI.Widget.VBox {
  ...
  constructor(columnData, addHeaderColumnCallback, changeHeaderColumnCallback, removeHeaderColumnCallback) {
    super(true);
    this.registerRequiredCSS('chii_network/networkManageCustomHeadersView.css');
    ...
    this._list.registerRequiredCSS('chii_network/networkManageCustomHeadersView.css');
    ...
    this.contentElement.appendChild(
      UI.UIUtils.createTextButton(
        Common.UIString.UIString('Add custom header…'),
